...
\and
\Infer{proj?}
{\Gamma  \vdash  \ottnt{v_{{\mathrm{1}}}}  \ottsym{:}  \top_\textsf{V}
\\\\
\Gamma  \vdash  \ottnt{v_{{\mathrm{2}}}}  \ottsym{:}  \top_\textsf{V}
}
{\Gamma  \vdash   \ottnt{v_{{\mathrm{1}}}} \left[  \ottnt{v_{{\mathrm{2}}}}  \right]_{  \texttt{?}  }   \ottsym{:}  \ottkw{F} \, \top_\textsf{V} }
\and
\Infer{proj!}
...
{\Gamma  \vdash   \texttt{openDb}_{  \texttt{?}  }~ \ottnt{v}   \ottsym{:}  \ottkw{F} \, \ottsym{(}  \ottkw{Db} \, \top_\textsf{V}  \ottsym{)}}
\and
\Infer{filterDb?}
{\Gamma  \vdash  \ottnt{v_{{\mathrm{1}}}}  \ottsym{:}  \ottkw{Db} \, \top_\textsf{V}
\\
\Gamma  \vdash  \ottnt{v_{{\mathrm{2}}}}  \ottsym{:}  \ottkw{U} \, \ottsym{(}  \top_\textsf{V}  \rightarrow  \ottkw{F} \, \ottsym{2}  \ottsym{)}
}
{\Gamma  \vdash   \texttt{filterDb}_{  \texttt{?}  }~ \ottnt{v_{{\mathrm{1}}}} ~ \ottnt{v_{{\mathrm{2}}}}   \ottsym{:}  \ottkw{F} \, \ottsym{(}  \ottkw{Db} \, \top_\textsf{V}  \ottsym{)}}
\and
\Infer{filterDb!}
...
\\\\
\Gamma  \vdash  \ottnt{v_{{\mathrm{3}}}}  \ottsym{:}  \ottkw{Db} \, \top_\textsf{V}
\\
\Gamma  \vdash  \ottnt{v_{{\mathrm{4}}}}  \ottsym{:}  \ottnt{B_{{\mathrm{4}}}}
}
{\Gamma  \vdash   \texttt{joinDb}_{  \texttt{?}  }~ \ottnt{v_{{\mathrm{1}}}} ~ \ottnt{v_{{\mathrm{2}}}} ~ \ottnt{v_{{\mathrm{3}}}} ~ \ottnt{v_{{\mathrm{4}}}}   \ottsym{:}  \ottkw{F} \, \ottsym{(}  \ottkw{Db} \, \top_\textsf{V}  \ottsym{)}}
\and
\Infer{joinDb!}
